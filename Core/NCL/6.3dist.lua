...
prepend_path("PATH","/util/opt/NCL/6.3dist/bin")
prepend_path("MANPATH","/util/opt/NCL/6.3dist/man")

setenv("NCARG_ROOT","/util/opt/NCL/6.3dist")
setenv("NCARG_INC","/util/opt/NCL/6.3dist/include")
setenv("NCARG_LIB","/util/opt/NCL/6.3dist/lib")
setenv("NCARG_BIN","/util/opt/NCL/6.3dist/bin")
