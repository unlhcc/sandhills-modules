...
prepend_path("PATH",                "/util/opt/ruby/2.0/gcc/4.4/bin")
prepend_path("LD_LIBRARY_PATH",     "/util/opt/ruby/2.0/gcc/4.4/lib")
prepend_path("MANPATH",             "/util/opt/ruby/2.0/gcc/4.4/share/man")
