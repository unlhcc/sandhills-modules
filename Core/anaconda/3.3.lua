...
prepend_path("PATH",                "/util/opt/anaconda3/2.3/bin")
prepend_path("MANPATH",             "/util/opt/anaconda3/2.3/share/man")
prepend_path{"PATH",                "/util/opt/anaconda3/2.3/envs/py33/bin",priority=100}
...
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda3/2.3/envs")
end
