...
prepend_path("PATH",                "/util/comp/pgi/linux86-64/13/bin")
prepend_path("LD_LIBRARY_PATH",     "/util/comp/pgi/linux86-64/13/lib")
prepend_path("LD_LIBRARY_PATH",     "/util/comp/pgi/linux86-64/13/libso")
prepend_path("MANPATH",             "/util/comp/pgi/linux86-64/13/man")
prepend_path("INCLUDE",             "/util/comp/pgi/linux86-64/13/include")
